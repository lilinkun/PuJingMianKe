 ...
 * description :
 */
public class HistoryActivitiesAdapter extends BaseQuickAdapter<HistoryActivitiesBean, BaseViewHolder> implements LoadMoreModule {


    public HistoryActivitiesAdapter(int layoutResId, @Nullable List<HistoryActivitiesBean> data) {
        super(layoutResId, data);
    }

    @Override
    protected void convert(@NotNull BaseViewHolder baseViewHolder, HistoryActivitiesBean record) {
