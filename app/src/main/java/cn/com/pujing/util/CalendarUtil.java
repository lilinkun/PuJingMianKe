...
public class CalendarUtil {
    ...
    public static boolean insertCalendarEvent(Context context, String title, String description,
                                              long beginTimeMillis, long endTimeMillis, String appName,int remainTime) {
        ...
        try {
            ...
            eventValues.put(CalendarContract.Events.EVENT_LOCATION, appName);
            ...
            reminderValues.put(CalendarContract.Reminders.MINUTES, remainTime); // 提前remainTime分钟提醒
    ...
    private static String CALENDARS_NAME = "pujing";
    private static String CALENDARS_ACCOUNT_NAME = "pujing@test.com";
    private static String CALENDARS_ACCOUNT_TYPE = "com.android.pujing";
    private static String CALENDARS_DISPLAY_NAME = "pujing";
    @Deprecated
