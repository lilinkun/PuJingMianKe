...
import cn.com.pujing.provider.CustomFileProvider;
import cn.com.pujing.util.AppInfoUtils;
import cn.com.pujing.util.UToast;
import cn.com.pujing.util.XLogUtils;
...
public class UpdateService extends Service {
    ...
    public void onCreate() {
        super.onCreate();
        UToast.showShort(getApplicationContext(), "正在下载中...");
    }
    ...
    public void openFile(File file, Context context) {
        ...
        try {
            ...
            e.printStackTrace();
            UToast.showShort(getApplicationContext(), "没有找到打开此类文件的程序!");
        }
    }
