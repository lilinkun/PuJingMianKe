...
public class ItemHeaderDecoration extends RecyclerView.ItemDecoration {
    ...
    private List<RestSortDetailBean> mDatas;
    ...
    public ItemHeaderDecoration(Context context, List<RestSortDetailBean> datas) {
        this.mDatas = datas;
    ...
    public ItemHeaderDecoration setData(List<RestSortDetailBean> mDatas) {
        this.mDatas = mDatas;
        return this;
    }
