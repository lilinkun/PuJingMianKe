...
public class AnotherExerciseItem {
    ...
    public static List<AnotherExerciseItem> getTestData() {
        ...
        anotherExerciseItem.imageRes = R.mipmap.ic_calendar_orange_star;
        ...
        anotherExerciseItem1.imageRes = R.mipmap.ic_calendar_orange_star;
        ...
        anotherExerciseItem2.imageRes = R.mipmap.ic_calendar_blue_star;
