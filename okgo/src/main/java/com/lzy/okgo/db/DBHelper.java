...
class DBHelper extends SQLiteOpenHelper {
    ...
    private final TableEntity cacheTableEntity = new TableEntity(TABLE_CACHE);
    private final TableEntity cookieTableEntity = new TableEntity(TABLE_COOKIE);
    private final TableEntity downloadTableEntity = new TableEntity(TABLE_DOWNLOAD);
    private final TableEntity uploadTableEntity = new TableEntity(TABLE_UPLOAD);
